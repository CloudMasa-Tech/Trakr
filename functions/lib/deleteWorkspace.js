...
async function handleDeleteWorkspace(data, callerEmail) {
 ...
 */
exports.deleteWorkspace = (0, https_1.onRequest)({
    ...
    try {
        ...
        const decoded = await (0, httpAuth_1.requireSuperAdmin)(req);
        ...
        v2_1.logger.error('deleteWorkspace request failed', {
            error: e.message,
            stack: e.stack,
        });

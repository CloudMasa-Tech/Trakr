...
class _ManagerRequestsScreenState extends State<ManagerRequestsScreen> {
  ...
  int _selectedTab = 0; // 0 for Leave, 1 for Permission, 2 for Checkout

  // Custom Colors following checkout request theme rules
  static const Color _cardColor = AppThemeColors.darkSurface;
  static const Color _borderColor = AppThemeColors.darkBorder;
  static const Color _primaryColor = Color(0xFF0F766E);
  static const Color _successColor = Color(0xFF16B86A);
  static const Color _dangerColor = Color(0xFFFF5B72);
  static const Color _warningColor = Color(0xFFFFB400);
  static const Color _textPrimary = AppThemeColors.darkText;
  static const Color _textSecondary = AppThemeColors.darkMuted;
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildTabButton(
              2, 'Checkout Requests', Icons.assignment_late_outlined),
        ],
      ),
    );
  }
